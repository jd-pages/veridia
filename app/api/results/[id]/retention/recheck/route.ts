...
/**
 * Legacy compatibility endpoint. It is not exposed by the UI and is never
 * invoked by a scheduler. Normal user-initiated re-audit remains unchanged.
 */
    ...
    tasks: [
      {
        ...
        expectedStoreTopics: parseStoredStringArray(result.task.expectedStoreTopics),
        requiredStoreTopics: parseStoredStringArray(result.task.requiredStoreTopics),
