...
export const PROTECTED_BEHAVIORS = Object.freeze([
  ...
  behavior({ key: "KABRITA_TEMPLATE_ISOLATION", module: "Kabrita import template", invariant: "Kabrita 模板保持独立解析，不得继承 Danone 阶段/段位语义。", unitTests: ["tests/unit/import-export-templates.test.ts", "tests/unit/danone-import-templates.test.ts"], e2eTests: ["tests/e2e/kabrita-excel-template.spec.ts", "tests/e2e/stage-import.spec.ts"], unitCases: [caseRef("tests/unit/import-export-templates.test.ts", "严格生成包含活动名称和系统是否符合列的14列表头并可识别模板品牌")], e2eCases: [caseRef("tests/e2e/kabrita-excel-template.spec.ts", "佳贝艾特14列导入模板下载、活动继承和六种购买产品线预检")], fixtures: ["tests/unit/import-export-templates.test.ts"], triggerFiles: ["lib/import-export-templates", "lib/product-stage.ts", "app/api/imports"] }),
